/**
 * HireBox™ Scale System
 * Логіка: Взаємовиключні маркери (STAR, CIRCLE, DASHED)
 */
  ...
  row.innerHTML = `
    ...
    <div class="chart-wrapper">
      ...
      <div class="chart-marker marker-star">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 480 519" class="marker-svg">
...
document.querySelector(".clear-all-btn").addEventListener("click", () => {
  ...
  // возврат select в состояние "select %"
  const select = document.getElementById("main-select");
  select.value = "";
});
